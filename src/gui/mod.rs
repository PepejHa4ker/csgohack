...
use gfx::Device;
use imgui::{Context, FontConfig, FontGlyphRanges, FontSource, Ui, ImStr};
...
pub fn init(title: &str) -> System {
    ...
    let events_loop = EventLoopExtWindows::new_any_thread();
...
//         &self.window.inner
//     }
//     pub fn update_views(&mut self, size: LogicalSize<f32>) {
